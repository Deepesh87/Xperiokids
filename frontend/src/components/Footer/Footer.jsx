...
const Footer = () => {
  ...
  const hiddenRoutes = ["/public-speaking-for-children", "/olympiad", "/summer", "/terms"];
  ...
  return (
    <footer className={`${styles.footer}`}>
      ...
      <ul className={`${styles.menu}`}>
        ...
        <li className={`${styles.menu__item}`}><a className={`${styles.menu__link}`} href="/public-speaking-for-children" target="_blank">Public Speaking</a></li>
...
<p>&copy;2025 xperiolearning.com | All rights Reserved</p>
      ...
      {!hiddenRoutes.includes(location.pathname) && (
        <div className={styles.summer_camp_notification}>
          <a href="/public-speaking-for-children" target="_blank" rel="noopener noreferrer">

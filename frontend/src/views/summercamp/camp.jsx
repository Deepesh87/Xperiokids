        ...
        <div className={styles.about}>
          <div className={styles.text}>
            ...
            <p>
              ...
              <a className={styles.menu__link} href="/camp24" target="_blank" rel="noopener noreferrer"> Summer Camp 2024</a>.
            </p>

            <p>
              To join an exclusive Robotics Camp during Summer Vacation, please visit here   
              <a className={styles.menu__link} href="/robotics" target="_blank" rel="noopener noreferrer"> Robotics Summer Camp</a>.
            </p>
